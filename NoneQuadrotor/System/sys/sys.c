...
/**********************************************************************************************************
*函数原型: void MY_NVIC_SetVectorTable(u32 NVIC_VectTab,u32 Offset)	
*函数功能: 设置向量表偏移地址
*输入参数: NVIC_VectTab:基址 Offset:偏移量		 
*返回数据: none
*修改日期: 2018-11-18
*备注信息：
**********************************************************************************************************/
...
/**********************************************************************************************************
*函数原型: void MY_NVIC_PriorityGroupConfig(u8 NVIC_Group)	 
*函数功能: 设置NVIC分组
*输入参数: NVIC_Group:NVIC分组 0~4 总共5组 		   
*返回数据: none
*修改日期: 2018-11-17
*备注信息：
**********************************************************************************************************/
...
/**********************************************************************************************************
*函数原型: void MY_NVIC_Init(u8 NVIC_PreemptionPriority,u8 NVIC_SubPriority,u8 NVIC_Channel,u8 NVIC_Group)	 
*函数功能: main函数入口
*输入参数: pvParameters
*返回数据: none
*修改日期: 2018-11-17
...
/**********************************************************************************************************
*函数原型: void Ex_NVIC_Config(u8 GPIOx,u8 BITx,u8 TRIM) 
*函数功能: 外部中断配置函数
*输入参数: 
*返回数据: none
*修改日期: 2018-11-17
...
/******************************************************************************************************************************************
*函数原型: void GPIO_AF_Set(GPIO_TypeDef* GPIOx,u8 BITx,u8 AFx)
*函数功能: GPIO复用设置
*输入参数: 
*返回数据: none
*修改日期: 2018-11-17
...
/**********************************************************************************************************
*函数原型: void GPIO_Pin_Set(GPIO_TypeDef* GPIOx,u16 pinx,u8 status)
*函数功能: 设置GPIO某个引脚的输出状态
*输入参数: GPIOx:GPIOA~GPIOI.pinx:引脚编号,范围:0~15
*返回数据: none
*修改日期: 2018-11-17
*备注信息：status:引脚状态(仅最低位有效),0,输出低电平;1,输出高电平
**********************************************************************************************************/
...
/**********************************************************************************************************
*函数原型: void Stm32_Clock_Init(u32 plln,u32 pllm,u32 pllp,u32 pllq)
*函数功能: 系统时钟初始化函数
*输入参数: 
*返回数据: 
*修改日期: 2018-11-17
*备注信息：plln:主PLL倍频系数(PLL倍频),取值范围:50~432.
           pllm:主PLL和音频PLL分频系数(PLL之前的分频),取值范围:2~63.
           pllp:系统时钟的主PLL分频系数(PLL之后的分频),取值范围:2,4,6,8.(仅限这4个值!)
           pllq:USB/SDMMC/随机数产生器等的主PLL分频系数(PLL之后的分频),取值范围:2~15.
**********************************************************************************************************/
