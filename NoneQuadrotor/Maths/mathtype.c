...
*备注信息：
**********************************************************************************************************/
void simple_3d_trans(Vector3f_t *ref, Vector3f_t *in, Vector3f_t *out) //小范围内
{
	static int8_t pn;
	static float h_tmp_x,h_tmp_y;
	
	h_tmp_x = my_sqrt(my_float_sqrt(ref->z) + my_float_sqrt(ref->y));
	h_tmp_y = my_sqrt(my_float_sqrt(ref->z) + my_float_sqrt(ref->x));
...
/**********************************************************************************************************
*函数原型: float fast_atan2(REAL y, REAL x) 
*函数功能: 
*输入参数: 
*返回数据: none
*修改日期: 2018-12-1
*备注信息：
**********************************************************************************************************/
float fast_atan2(REAL y, REAL x) 
{
	float x_abs, y_abs, z;
...
/**********************************************************************************************************
*函数原型: float my_atan(float x, float y)
*函数功能: 
*输入参数: 
*返回数据: none
*修改日期: 2018-12-1
...
/**********************************************************************************************************
*函数原型: float my_deathzoom(float x,float zoom)
*函数功能: 获取P控制
...
/**********************************************************************************************************
*函数原型: float my_deathzoom_2(float x,float zoom)
*函数功能: 
*输入参数: 
*返回数据: none
*修改日期: 2018-11-30
